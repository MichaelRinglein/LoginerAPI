...
const schema = new Schema({
    ...
    restaurantReviewImg: { type: String, unique: false, required: false },
    restaurantReviewCounter: { type: Number, unique: false, required: false, value: 0 },
    restaurantVoucherName: { type: String, unique: false, required: false },
    restaurantVoucherImg: { type: String, unique: false, required: false },
    restaurantVoucherCode: { type: String, unique: false, required: false },
    restaurantVoucherCounter: { type: Number, unique: false, required: false, value: 0 },
